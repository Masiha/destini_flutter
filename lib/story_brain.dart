...
// Use the storyNumber property inside getStory(), getChoice1() and getChoice2() so that it gets the updated story and choices.
// The storyNumber property is a private property so that only story_brain.dart has access to it.
  int _storyNumber = 0;

// The story plan here: https://drive.google.com/uc?export=download&id=1KU6EghkO9Hf2hRM0756xFHgNaZyGCou3
